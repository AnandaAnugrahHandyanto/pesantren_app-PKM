<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-slate-900 dark:text-white">Jadwal Mengajar</h1>
                <p class="text-xs text-slate-900 dark:text-slate-500 dark:text-white/50">Guru: {{ $guru->nama_lengkap ?? '-' }}</p>
            </div>
        </div>
    </x-slot>
