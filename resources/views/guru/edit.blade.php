<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-lg font-semibold text-slate-900 dark:text-white">Edit Guru</h1>
                <p class="text-xs text-slate-900 dark:text-slate-500 dark:text-white/50">Ubah data guru dan akun login</p>
            </div>
        </div>
    </x-slot>
