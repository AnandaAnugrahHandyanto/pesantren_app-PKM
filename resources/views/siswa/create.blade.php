                        ...
                        <label for="rombel" class="mb-1 block text-sm font-medium text-white/80">Rombel <span aria-hidden="true">*</span></label>
                                                <div class="relative">
                                                    <select id="rombel" name="rombel" required aria-label="Pilih rombel"
                                                        ...
                                                        <option value="" disabled {{ old('rombel') ? '' : 'selected' }} class="bg-indigo-950 text-white">Pilih rombel</option>
                                                        @foreach ($rombelOptions as $j)
                                                            <option value="{{ $j }}" {{ old('rombel') === $j ? 'selected' : '' }} class="bg-indigo-950 text-white">{{ $j }}</option>
                                                        @endforeach
                                                    </select>
