...
>
    ...
    <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-4 text-sm">
        @if (Auth::user()->role === 'admin')
            ...
            <div class="space-y-1">
                <p class="px-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Data</p>
            ...
            <div class="space-y-1">
                <p class="px-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Absensi</p>
            ...
            <div class="space-y-1">
                <p class="px-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Keuangan</p>
        ...
        @elseif (Auth::user()->role === 'guru')
            ...
            <div class="space-y-1">
                <p class="px-3 text-xs font-semibold text-white/50 uppercase tracking-wider">Akademik</p>
                <a href="{{ route('absensi.index') }}"
                    class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition {{ request()->routeIs('absensi.*') ? 'bg-white/20 text-white shadow-sm' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    <svg class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                ...
                <a href="{{ route('guru.jadwal') }}"
                    class="flex items-center gap-3 rounded-xl px-3 py-2.5 transition {{ request()->routeIs('guru.jadwal') ? 'bg-white/20 text-white shadow-sm' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                    <svg class="h-4 w-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                    </svg>
                    Jadwal
