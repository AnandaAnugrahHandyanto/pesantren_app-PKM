...
<body>
    ...
    <div class="no-print">
        <button onclick="window.print()" class="flex items-center gap-2 rounded-lg bg-slate-50 dark:bg-white/10 px-4 py-2 text-sm text-slate-900 dark:text-slate-700 dark:text-white/80 ring-1 ring-white/20 hover:bg-white/20">
